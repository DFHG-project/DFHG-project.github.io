...
For a complete searchable catalog of the witnesses who preserve text reuses of the FHG authors, see the [DFHG Witnesses Catalog](http://www.dfhg-project.org/Witnesses-Catalog/). The Catalog offers a [Witnesses Map](http://www.dfhg-project.org/Witnesses-Catalog/map.php), a [Witnesses (Authors) Char](http://www.dfhg-project.org/Witnesses-Catalog/authors_char.php), a [Witnesses (Works) Char](http://www.dfhg-project.org/Witnesses-Catalog/works_char.php), and a [Witnesses Timeline](http://www.dfhg-project.org/Witnesses-Catalog/timeline.php). The Catalog includes also experimental text reuse detection. 
